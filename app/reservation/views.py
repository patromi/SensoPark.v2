...
def numbers_of_free_parkings():
    list2 = []
    ###Do zmiany od razu pobrać baze danych!!!###
...
#         try:
#             x = '02/13/21 ' + form.end_time_reservation.data
#             y = '02/13/21 ' + form.start_time_reservation.data
#
#             # print(x, y)
#             print(alcorythm.alcorythm_reservation(id, y, x))
#             if not alcorythm.alcorythm_reservation(id, y, x) or x == y:
#                 wynik = True
#             else:
#
#                 reservation = Parking_reservation(user1_id=current_user.id, parking_id=id,
#                                                   date_reservation='02-13-21',
#                                                   start_time_reservation=form.start_time_reservation.data,
#                                                   end_time_reservation=form.end_time_reservation.data)
#                 db.session.add(reservation)
#                 db.session.commit()
#                 return redirect(url_for('reservation.parking_reservation', id=id))
#         except:
#             pass
